---
name: x-search
description: Search X/Twitter posts, get user profiles, read individual tweets, browse timelines, and check trending topics via TweetX402's pay-per-use x402 API through the Obul proxy.
